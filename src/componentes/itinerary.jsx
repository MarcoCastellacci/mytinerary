...
export default function Itinerarys(props) {
    ...
    //     const res = await dispatch(itineraryActions.addLikes(itinerary._id));
    //     alerts(res);
    //     setReload(res);
    // };
    ...
    return (
        <Card sx={{ width: '90vw', bgcolor: 'rgba(0, 0, 0, 0.651)', color: 'white', margin: '2rem' }} >
            ...
            <CardActions disableSpacing >
                {
                    user ?
                        (<IconButton sx={{ margin: '.5rem', marginY: '0' }} >
                            ...
                            {user.id !== comment.user._id ?
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center' }}>
                                    ...
                                    <div className='comment-button'>
                                        <button id={comment._id} className="btn-comment">
                                            Modify
                                        </button>
                                        <button id={comment._id} className="btn-comment">
                                            Delete
